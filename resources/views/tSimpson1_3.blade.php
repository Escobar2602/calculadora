...
<body>
    <div class="p-6 sm:ml-64 bg-gray-50 min-h-screen">
        <h1 class="text-3xl font-bold mb-6 text-gray-800">Cálculo de Integral Definida - Método de Simpson 1/3</h1>

        <form id="integralForm" class="space-y-4 bg-white p-6 rounded-lg shadow-md">
            <div>
            ...
            <div>
                <label for="customFunction" class="block text-lg font-medium text-gray-700 mb-2">Función personalizada (si es el caso):</label>
