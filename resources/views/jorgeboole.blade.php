...
<div class="p-6 sm:ml-64 bg-gray-50 min-h-screen">
    ...
    <form id="booleForm" class="space-y-4 bg-white p-6 rounded-lg shadow-md">
        <div>
        ...
        <div>
            ...
            <input type="number" id="a" class="block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" value="0" required />
        </div>

        <div>
            <label for="b" class="block text-lg font-medium text-gray-700 mb-2">Límite superior (b):</label>
            <input type="number" id="b" class="block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" value="1" required />
        </div>
