...
<body>
    <div class="p-6 sm:ml-64 bg-gray-50 min-h-screen">
        ...
        <form id="simpsonForm" class="space-y-4 bg-white p-6 rounded-lg shadow-md">
            <div>
                <label for="a" class="block text-lg font-medium text-gray-700 mb-2">Valor de a (límite inferior):</label>
                <input type="number" step="any" id="a" class="block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            </div>

            <div>
                <label for="b" class="block text-lg font-medium text-gray-700 mb-2">Valor de b (límite superior):</label>
                <input type="number" step="any" id="b" class="block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            </div>

            <div>
                <label for="n" class="block text-lg font-medium text-gray-700 mb-2">Número de particiones (n debe ser par):</label>
                <input type="number" id="n" class="block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required min="2" step="2">
            </div>

            <div>
                <label for="funcion" class="block text-lg font-medium text-gray-700 mb-2">Función f(x):</label>
                <input type="text" id="funcion" class="block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ejemplo: x^2 + 3*x" required>
            </div>

            <button type="submit" class="w-full bg-blue-500 text-white font-bold py-2 px-4 rounded-md hover:bg-blue-600 transition duration-300">Calcular</button>
        </form>
